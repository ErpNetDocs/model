...
|                      | && Config./Accounting/AccountingVoucherLines/AllowBaseCurrencyLineAmountMismatch != 1   )     |
|                      | <br/><br/>                                                                                    |
|                      | Debit = DebitBase                                                                             |
|                      | <br/><br/>                                                                                    |
|                      | Credit = CreditBase                                                                           |
...
|                      | Updated: 26.1 - Added condition by the config option                                          |
|                      | /Accounting/AccountingVoucherLines/AllowBaseCurrencyLineAmountMismatch. If its value          |
|                      | is equal to 1, then the validation is not performed.                                          |
+----------------------+-----------------------------------------------------------------------------------------------+
| **Revocable**        | YES                                                                                           |
+----------------------+-----------------------------------------------------------------------------------------------+
