...
| Action | On Voiding <br>​ <br>
For each WarehouseCount related to the current document: <br> - Set Void = True <br> - Set VoidTime = Now <br> - Set VoidUser = Document.VoidUser <br> - Set VoidReason = Document.VoidReason |
