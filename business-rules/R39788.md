...
| Action | For each WarehouseCount related to the current document: <br> - Set Void = True <br> - Set VoidTime = Now <br> - Set VoidUser = CurrentUser <br> - Set VoidReason = The document has been voided |
