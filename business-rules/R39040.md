...
| Message | The selected Currency is invalid. <br/> This account allows only '{Account.Currency}' or, if limited to base currency, the enterprise company's Base '{AccountingVoucher.EnterpriseCompany.BaseCurrency}', Reporting '{AccountingVoucher.EnterpriseCompany.ReportingCurrency}' currency or New Value Currency ‘{InstanceChangeRequest.NewValueCurrency}’. <br/> Please select a valid currency. |
