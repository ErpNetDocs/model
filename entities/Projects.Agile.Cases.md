...
| [Specification](Projects.Agile.Cases.md#specification) | string (max) __nullable__ | Defines the functionality that must be implemented. It should describe the expected system behaviour and acceptance criteria, without including discussions, rationale, or research.`Filter(like)` `Introduced in version 26.2.1.78` |
...
| [AdditionalDataJson](Projects.Agile.Cases.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
...
Defines the functionality that must be implemented. It should describe the expected system behaviour and acceptance criteria, without including discussions, rationale, or research.`Filter(like)` `Introduced in version 26.2.1.78`
