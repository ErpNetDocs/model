...
Repository: Projects.Classic.TaskTypes  
Base Table: Prj_Task_Types  
...
| [ExternalId](Projects.Classic.TaskTypes.md#externalid) | string | The id of the object, when it is imported/synchronized with external system. Used by sync apps to identify the object in external systems. [Filter(multi eq)] [ORD] [Introduced in version 24.1.0.89] |
| [ExternalSystem](Projects.Classic.TaskTypes.md#externalsystem) | string | The name of the external system from which the object is imported/synchronized. [Filter(multi eq)] [Introduced in version 24.1.0.89] |
...
| [AdditionalDataJson](Projects.Classic.TaskTypes.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
...
Projects_Classic_TaskTypes

Domain API Entity Type: 
Projects_Classic_TaskType

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Projects_Classic_TaskTypes?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Projects_Classic_TaskTypes?$top=10>
