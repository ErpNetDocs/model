...
Repository: Applications.Service.ServiceActivityAgreedServices  
Base Table: Srv_Service_Activity_Agreed_Services  
API access:  ReadWrite  

## Visualization
Display Format: {ServiceActivityService.ServiceName}  
Search Members: ServiceActivityService.ServiceName  
Name Member: ServiceActivityService.ServiceName  
...
| ---- | ---- | --- |
| [AgreedQuantity](Applications.Service.ServiceActivityAgreedServices.md#agreedquantity) | [Quantity (18, 3)](../data-types.md#quantity) | Quantity from the service agreement service line that is accounted for this service activity service line. 
...
| [ServiceAgreementService](Applications.Service.ServiceActivityAgreedServices.md#serviceagreementservice) | [ServiceAgreementServices](Applications.Service.ServiceAgreementServices.md) | Service agreement service line that records the paid or agreed in advance service or product. |
...
Type: **[ServiceActivityServices](Applications.Service.ServiceActivityServices.md)**  
Indexed: **True**  
Category: **System**  
...
Type: **[ServiceAgreementServices](Applications.Service.ServiceAgreementServices.md)**  
Category: **System**  
Supported Filters: **Equals, EqualsIn**  
Show in UI: **ShownByDefault**  
...
Applications_Service_ServiceActivityAgreedServices

Domain API Entity Type: 
Applications_Service_ServiceActivityAgreedService

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Applications_Service_ServiceActivityAgreedServices?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Applications_Service_ServiceActivityAgreedServices?$top=10>
