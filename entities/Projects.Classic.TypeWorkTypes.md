---
uid: Projects.Classic.TypeWorkTypes
---
# Projects.Classic.TypeWorkTypes
...
Repository: Projects.Classic.TypeWorkTypes  
Base Table: Prj_Type_Work_Types  
API access:  ReadWrite  

## Visualization
Display Format: {WorkTypeName}  
Search Members: WorkTypeName  
Name Member: WorkTypeName  
Category:  Settings  
...
[!list limit=1000 erp.entity=Projects.Classic.TypeWorkTypes erp.type=business-rule default-text="None"]

## Front-End Business Rules

[!list limit=1000 erp.entity=Projects.Classic.TypeWorkTypes erp.type=front-end-business-rule default-text="None"]

## API

Domain API Entity Set: 
Projects_Classic_TypeWorkTypes

Domain API Entity Type: 
Projects_Classic_TypeWorkType

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Projects_Classic_TypeWorkTypes?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Projects_Classic_TypeWorkTypes?$top=10>
