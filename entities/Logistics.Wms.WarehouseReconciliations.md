...
| [EnterpriseCompanyLocation](Logistics.Wms.WarehouseReconciliations.md#enterprisecompanylocation) | [CompanyLocations](General.Contacts.CompanyLocations.md) (nullable) | The branch of the enterprise company that issues the document. . `Filter(multi eq)` (Inherited from [Documents](General.Documents.Documents.md)) |
...
The warehouse where the reconciliation will be executed.
