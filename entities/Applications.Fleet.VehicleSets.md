...
Repository: Applications.Fleet.VehicleSets  
Base Table: Fleet_Vehicle_Sets  
...
Applications_Fleet_VehicleSets

Domain API Entity Type: 
Applications_Fleet_VehicleSet

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Applications_Fleet_VehicleSets?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Applications_Fleet_VehicleSets?$top=10>
