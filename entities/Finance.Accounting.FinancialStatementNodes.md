...
Defines the hierarchical structure of a financial statement, organizing rows and sections into nested groups. Each node represents a subtotal, header, or individual line item.

## General
Namespace: [Finance.Accounting](Finance.Accounting.md)  
Repository: Finance.Accounting.FinancialStatementNodes  
Base Table: Acc_Financial_Statement_Nodes  
...
Type: **[FinancialStatements](Finance.Accounting.FinancialStatements.md)**  
Indexed: **True**  
Category: **System**  
...
Finance_Accounting_FinancialStatementNodes

Domain API Entity Type: 
Finance_Accounting_FinancialStatementNode

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Accounting_FinancialStatementNodes?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Accounting_FinancialStatementNodes?$top=10>
