...
Repository: Crm.Marketing.TargetGroupMembers  
Base Table: Crm_Target_Group_Members  
API access:  ReadWrite  

## Visualization
Display Format: {TargetGroup.Name}  
Search Members: TargetGroup.Name  
Name Member: TargetGroup.Name  
...
Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Crm_Marketing_TargetGroupMembers?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Crm_Marketing_TargetGroupMembers?$top=10>
