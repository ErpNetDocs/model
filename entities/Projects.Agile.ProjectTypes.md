---
uid: Projects.Agile.ProjectTypes
---
# Projects.Agile.ProjectTypes


User-classified project type.

## General
Namespace: [Projects.Agile](Projects.Agile.md)  
Repository: Projects.Agile.ProjectTypes  
Base Table: Apm_Project_Types  
Introduced In Version: 24.1.1.65  
...
| [AdditionalDataJson](Projects.Agile.ProjectTypes.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
...
[!list limit=1000 erp.entity=Projects.Agile.ProjectTypes erp.type=business-rule default-text="None"]

## Front-End Business Rules

[!list limit=1000 erp.entity=Projects.Agile.ProjectTypes erp.type=front-end-business-rule default-text="None"]

## API

Domain API Entity Set: 
Projects_Agile_ProjectTypes

Domain API Entity Type: 
Projects_Agile_ProjectType

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Projects_Agile_ProjectTypes?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Projects_Agile_ProjectTypes?$top=10>
