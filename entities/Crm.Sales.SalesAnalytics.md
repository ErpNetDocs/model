...
| ---- | ---- | --- |
| [DocumentDate](Crm.Sales.SalesAnalytics.md#documentdate) | date | Date to group for 
| [LineAmount](Crm.Sales.SalesAnalytics.md#lineamount) | decimal (38, 2) | Line Amount for date 
| [LineDiscountAmount](Crm.Sales.SalesAnalytics.md#linediscountamount) | decimal (38, 2) | Discount over Line Amount for Date 
| [QuantityBase](Crm.Sales.SalesAnalytics.md#quantitybase) | decimal (38, 3) | Base Quantity for Date 
| [SalesAnalyticId](Crm.Sales.SalesAnalytics.md#salesanalyticid) | guid | Row Id. `Required` `Filter(multi eq)` 
| [StandardQuantityBase](Crm.Sales.SalesAnalytics.md#standardquantitybase) | decimal (38, 3) | Standard Base Quantity for Date 
