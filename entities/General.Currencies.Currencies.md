...
Repository: General.Currencies.Currencies  
Base Table: Gen_Currencies  
...
## Visualization
Display Format: {CurrencySign}  
Search Members: CurrencySign; Name  
Code Member: CurrencySign  
Name Member: Name  
Category:  Settings  
...
| [AggregateLastUpdateTimeUtc](General.Currencies.Currencies.md#aggregatelastupdatetimeutc) | datetime | The exact server time (in UTC) of the last modification of the object represented by this system object. null means that it is unknown. [Filter(ge;le)] [ORD] [Introduced in version 19.1] |
| [AdditionalDataJson](General.Currencies.Currencies.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
