...
Contains recipients, to which personal data is disclosed.

## General
Namespace: [Applications.PersonalData](Applications.PersonalData.md)  
Repository: Applications.PersonalData.PersonalDataProcessRecipients  
Base Table: Pdm_Personal_Data_Process_Recipients  
...
Applications_PersonalData_PersonalDataProcessRecipients

Domain API Entity Type: 
Applications_PersonalData_PersonalDataProcessRecipient

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Applications_PersonalData_PersonalDataProcessRecipients?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Applications_PersonalData_PersonalDataProcessRecipients?$top=10>
