...
Repository: Finance.Cost.Templates  
Base Table: Cost_Templates  
API access:  ReadWrite  

## Visualization
Display Format: {CostTemplateName}  
Search Members: CostTemplateCode; CostTemplateName  
Code Member: CostTemplateCode  
Name Member: CostTemplateName  
Category:  Settings  
...
| [ExternalId](Finance.Cost.Templates.md#externalid) | string | The id of the object, when it is imported/synchronized with external system. Used by sync apps to identify the object in external systems. [Filter(multi eq)] [ORD] [Introduced in version 24.1.0.89] |
| [ExternalSystem](Finance.Cost.Templates.md#externalsystem) | string | The name of the external system from which the object is imported/synchronized. [Filter(multi eq)] [Introduced in version 24.1.0.89] |
| [AggregateLastUpdateTimeUtc](Finance.Cost.Templates.md#aggregatelastupdatetimeutc) | datetime | The exact server time (in UTC) of the last modification of the object represented by this system object. null means that it is unknown. [Filter(ge;le)] [ORD] [Introduced in version 19.1] |
| [AdditionalDataJson](Finance.Cost.Templates.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
...
Finance_Cost_Templates

Domain API Entity Type: 
Finance_Cost_Template

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Cost_Templates?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Cost_Templates?$top=10>
