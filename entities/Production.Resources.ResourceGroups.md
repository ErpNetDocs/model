...
| ---- | ---- | --- |
| [FullPath](Production.Resources.ResourceGroups.md#fullpath) | string (254) | The full path to the operation group. The full path starts with, ends with and is delimited by the "/" (forward slash) character. 
| [Name](Production.Resources.ResourceGroups.md#name) | string (64) | Name of resource group 
| [Parent](Production.Resources.ResourceGroups.md#parent) | string (254) | Dot-separated list of parent groups. It also contains leading and trailing dot. 
...
| Name | Type | Description |
| ---- | ---- | --- |
| [Id](Production.Resources.ResourceGroups.md#id) | guid | Unique, autogenerated resource group id 
