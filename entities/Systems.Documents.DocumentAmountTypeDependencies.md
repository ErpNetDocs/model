...
---
# Systems.Documents.DocumentAmountTypeDependencies
...
Repository: Systems.Documents.DocumentAmountTypeDependencies  
Base Table: Gen_Document_Amount_Type_Dependencies  
...
Systems_Documents_DocumentAmountTypeDependencies

Domain API Entity Type: 
Systems_Documents_DocumentAmountTypeDependency

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Systems_Documents_DocumentAmountTypeDependencies?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Systems_Documents_DocumentAmountTypeDependencies?$top=10>
