...
Repository: Logistics.Inventory.StoreBins  
Base Table: Inv_Store_Bins  
...
Logistics_Inventory_StoreBins

Domain API Entity Type: 
Logistics_Inventory_StoreBin

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Logistics_Inventory_StoreBins?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Logistics_Inventory_StoreBins?$top=10>
