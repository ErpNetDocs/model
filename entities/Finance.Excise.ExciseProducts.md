...
| ---- | ---- | --- |
| [AggregateLastUpdateTimeUtc](Finance.Excise.ExciseProducts.md#aggregatelastupdatetimeutc) | datetime | The exact server time (in UTC) of the last modification of the object represented by this system object. null means that it is unknown. [Filter(ge;le)] [ORD] [Introduced in version 19.1] 
...
Finance_Excise_ExciseProducts

Domain API Entity Type: 
Finance_Excise_ExciseProduct

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Excise_ExciseProducts?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Excise_ExciseProducts?$top=10>
