---
uid: Regulatory.Saft.ProfileAccountByAdditionalAmounts
---
# Regulatory.Saft.ProfileAccountByAdditionalAmounts Entity

**Namespace:** [Regulatory.Saft](Regulatory.Saft.md)  

Maps the SAF-T account by Amount type for a selected SAF-T profile. Entity: Saft_Profile_Account_By_Additional_Amounts (Introduced in version 26.2.1.18)
...
_Allowed Values (Regulatory.Saft.ProfileAccountByProductsRepository.DebitCreditIndicator Enum Members)_  
...
_Allowed Values (Regulatory.Saft.ProfileAccountByProductsRepository.EntityKind Enum Members)_  
...
[!list limit=1000 erp.entity=Regulatory.Saft.ProfileAccountByAdditionalAmounts erp.type=business-rule default-text="None"]

## Front-End Business Rules

[!list limit=1000 erp.entity=Regulatory.Saft.ProfileAccountByAdditionalAmounts erp.type=front-end-business-rule default-text="None"]

## API

Domain API Entity Set: 
Regulatory_Saft_ProfileAccountByAdditionalAmounts

Domain API Entity Type: 
Regulatory_Saft_ProfileAccountByAdditionalAmount

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Regulatory_Saft_ProfileAccountByAdditionalAmounts?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Regulatory_Saft_ProfileAccountByAdditionalAmounts?$top=10>
