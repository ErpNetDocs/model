...
Finance_Intrastat_DeclarationLines

Domain API Entity Type: 
Finance_Intrastat_DeclarationLine

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Intrastat_DeclarationLines?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Intrastat_DeclarationLines?$top=10>
