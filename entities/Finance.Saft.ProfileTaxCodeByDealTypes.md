---
uid: Finance.Saft.ProfileTaxCodeByDealTypes
---
# Finance.Saft.ProfileTaxCodeByDealTypes Entity
...
| ---- | ---- | --- |
| [DisplayText](Finance.Saft.ProfileTaxCodeByDealTypes.md#displaytext) | string | Uses the repository DisplayTextFormat to build the display text from the attributes and references of current object. 
| [Id](Finance.Saft.ProfileTaxCodeByDealTypes.md#id) | guid |  
| [Notes](Finance.Saft.ProfileTaxCodeByDealTypes.md#notes) | string (max) __nullable__ | Additional explanation or comments about this mapping rule (e.g., rationale, special cases, internal reference). `Filter(like)` 
| [ObjectVersion](Finance.Saft.ProfileTaxCodeByDealTypes.md#objectversion) | int32 | The latest version of the extensible data object for the aggregate root for the time the object is loaded from the database. Can be used for optimistic locking. 
...
[!list limit=1000 erp.entity=Finance.Saft.ProfileTaxCodeByDealTypes erp.type=business-rule default-text="None"]

## Front-End Business Rules

[!list limit=1000 erp.entity=Finance.Saft.ProfileTaxCodeByDealTypes erp.type=front-end-business-rule default-text="None"]

## API

Domain API Entity Set: 
Finance_Saft_ProfileTaxCodeByDealTypes

Domain API Entity Type: 
Finance_Saft_ProfileTaxCodeByDealType

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Saft_ProfileTaxCodeByDealTypes?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Saft_ProfileTaxCodeByDealTypes?$top=10>
