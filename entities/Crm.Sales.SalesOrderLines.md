...
| [TaxAmount](Crm.Sales.SalesOrderLines.md#taxamount) | [Amount (12, 2)](../data-types.md#amount) __nullable__ | The pre-calculated tax amount for this specific line, captured from the source system (e.g., POS)`Currency: SalesOrder.DocumentCurrency` `Introduced in version 26.2.2.5` |
...
The pre-calculated tax amount for this specific line, captured from the source system (e.g., POS)`Currency: SalesOrder.DocumentCurrency` `Introduced in version 26.2.2.5`
