...
Repository: Finance.Assets.DepreciationAssets  
Base Table: Ast_Depreciation_Assets  
API access:  ReadWrite  

## Visualization
Display Format: {Depreciation.EntityName}  
Search Members: Depreciation.EntityName  
Name Member: Depreciation.EntityName  
...
Type: **[Depreciations](Finance.Assets.Depreciations.md)**  
Indexed: **True**  
Category: **System**  
Supported Filters: **Equals, EqualsIn**  
...
Finance_Assets_DepreciationAssets

Domain API Entity Type: 
Finance_Assets_DepreciationAsset

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Assets_DepreciationAssets?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Assets_DepreciationAssets?$top=10>
