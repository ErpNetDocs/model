...
| [<s>IsReleased</s>](Production.ShopFloor.OutputOrders.md#isreleased) | boolean | **OBSOLETE! Do not use!** True if the document is not void and its state is released or greater. Deprecated 
| [IsSingleExecution](Production.ShopFloor.OutputOrders.md#issingleexecution) | boolean | Specifies whether the document is a single execution of its order document. 
...
| [<s>Status</s>](Production.ShopFloor.OutputOrders.md#status) | string (1) | **OBSOLETE! Do not use!** N=New,P=Planned, F=Firm planned, R=Released(WIP), C=Completed 
