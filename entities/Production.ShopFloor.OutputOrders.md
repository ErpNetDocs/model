...
| [WorkOrder](Production.ShopFloor.OutputOrders.md#workorder) | [WorkOrders](Production.ShopFloor.WorkOrders.md) (nullable) | The Work Order for which this Output Order is storing data. `Filter(multi eq)` |
