...
Repository: Crm.Sales.DefaultSalesOrderDocumentProperties  
Base Table: Crm_Default_Sales_Order_Document_Properties  
...
Crm_Sales_DefaultSalesOrderDocumentProperties

Domain API Entity Type: 
Crm_Sales_DefaultSalesOrderDocumentProperty

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Crm_Sales_DefaultSalesOrderDocumentProperties?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Crm_Sales_DefaultSalesOrderDocumentProperties?$top=10>
