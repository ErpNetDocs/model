...
Repository: Systems.Bpm.PropertyValues  
Base Table: Gen_Property_Values  
...
## Visualization
Display Format: {Id}: {EntityItemId}  
Search Members:   
...
| [ExternalId](Systems.Bpm.PropertyValues.md#externalid) | string | The id of the object, when it is imported/synchronized with external system. Used by sync apps to identify the object in external systems. [Filter(multi eq)] [ORD] [Introduced in version 24.1.0.89] |
| [ExternalSystem](Systems.Bpm.PropertyValues.md#externalsystem) | string | The name of the external system from which the object is imported/synchronized. [Filter(multi eq)] [Introduced in version 24.1.0.89] |
...
| [AdditionalDataJson](Systems.Bpm.PropertyValues.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
...
Systems_Bpm_PropertyValues

Domain API Entity Type: 
Systems_Bpm_PropertyValue

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Systems_Bpm_PropertyValues?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Systems_Bpm_PropertyValues?$top=10>
