...
Specifies how each node in a financial statement is calculated by linking it to account filters. These correspondences determine which accounts, ranges, or rules contribute to each line.

## General
Namespace: [Finance.Accounting](Finance.Accounting.md)  
Repository: Finance.Accounting.FinancialStatementNodeCorrespondances  
Base Table: Acc_Financial_Statement_Node_Correspondances  
API access:  ReadWrite  

## Visualization
Display Format: {FinancialStatementNode.Name:T}  
Search Members: FinancialStatementNode.Name  
Name Member: FinancialStatementNode.Name  
...
Type: **[FinancialStatementNodes](Finance.Accounting.FinancialStatementNodes.md)**  
Category: **System**  
Supported Filters: **Equals, EqualsIn**  
...
Finance_Accounting_FinancialStatementNodeCorrespondances

Domain API Entity Type: 
Finance_Accounting_FinancialStatementNodeCorrespondance

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Accounting_FinancialStatementNodeCorrespondances?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Accounting_FinancialStatementNodeCorrespondances?$top=10>
