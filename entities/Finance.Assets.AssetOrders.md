...
| [Operation](Finance.Assets.AssetOrders.md#operation) | [Operation](Finance.Assets.AssetOrders.md#operation) | Operation performed with this order: PUR = Purchase, SLS = Sale. `Required` `Filter(multi eq)` 
