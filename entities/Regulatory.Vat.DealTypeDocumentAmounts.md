...
---
# Regulatory.Vat.DealTypeDocumentAmounts


Contains custom percent ratios for additional amount distribution over products for VAT purposes.

## General
Namespace: [Regulatory.Vat](Regulatory.Vat.md)  
Repository: Regulatory.Vat.DealTypeDocumentAmounts  
Base Table: VAT_Deal_Type_Document_Amounts  
Introduced In Version: 22.1.4.19  
API access:  ReadWrite  

## Visualization
Display Format: {DealType.Name}  
Search Members: DealType.Name  
Name Member: DealType.Name  
