---
uid: Finance.Saft.ProfileAccounts
---
# Finance.Saft.ProfileAccounts Entity
...
| ---- | ---- | --- |
| [AccountType](Finance.Saft.ProfileAccounts.md#accounttype) | [AccountType](Finance.Saft.ProfileAccounts.md#accounttype) | Account classification in SAF-T. `Required` `Filter(eq)` 
| [DisplayText](Finance.Saft.ProfileAccounts.md#displaytext) | string | Uses the repository DisplayTextFormat to build the display text from the attributes and references of current object. 
...
_Type_: **[AccountType](Finance.Saft.ProfileAccounts.md#accounttype)**  
_Category_: **System**  
Allowed values for the `AccountType`(Finance.Saft.ProfileAccounts.md#accounttype) data attribute  
_Allowed Values (Finance.Saft.ProfileAccountsRepository.AccountType Enum Members)_  

| Value | Description |
| ---- | --- |
| Active | Active. Stored as 'ACT'. <br /> _Database Value:_ 'ACT' <br /> _Model Value:_ 0 <br /> _Domain API Value:_ 'Active' |
| Passive | Passive. Stored as 'PAS'. <br /> _Database Value:_ 'PAS' <br /> _Model Value:_ 1 <br /> _Domain API Value:_ 'Passive' |
| Bifunctional | Bifunctional. Stored as 'BIF'. <br /> _Database Value:_ 'BIF' <br /> _Model Value:_ 2 <br /> _Domain API Value:_ 'Bifunctional' |
...
[!list limit=1000 erp.entity=Finance.Saft.ProfileAccounts erp.type=business-rule default-text="None"]

## Front-End Business Rules

[!list limit=1000 erp.entity=Finance.Saft.ProfileAccounts erp.type=front-end-business-rule default-text="None"]

## API

Domain API Entity Set: 
Finance_Saft_ProfileAccounts

Domain API Entity Type: 
Finance_Saft_ProfileAccount

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Saft_ProfileAccounts?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Saft_ProfileAccounts?$top=10>
