---
uid: Regulatory.Common.Jurisdictions
---
# Regulatory.Common.Jurisdictions


Represents a single coherent legal authority that governs a geographic or political area.

## General
Namespace: [Regulatory.Common](Regulatory.Common.md)  
Repository: Regulatory.Common.Jurisdictions  
Base Table: Reg_Jurisdictions  
...
Aggregate Tree  
* [Regulatory.Common.Jurisdictions](Regulatory.Common.Jurisdictions.md)  
...
| [AdditionalDataJson](Regulatory.Common.Jurisdictions.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
...
[!list limit=1000 erp.entity=Regulatory.Common.Jurisdictions erp.type=business-rule default-text="None"]

## Front-End Business Rules

[!list limit=1000 erp.entity=Regulatory.Common.Jurisdictions erp.type=front-end-business-rule default-text="None"]

## API

Domain API Entity Set: 
Regulatory_Common_Jurisdictions

Domain API Entity Type: 
Regulatory_Common_Jurisdiction

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Regulatory_Common_Jurisdictions?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Regulatory_Common_Jurisdictions?$top=10>
