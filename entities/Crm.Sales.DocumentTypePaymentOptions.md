...
Repository: Crm.Sales.DocumentTypePaymentOptions  
Base Table: Crm_Document_Type_Payment_Options  
...
Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Crm_Sales_DocumentTypePaymentOptions?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Crm_Sales_DocumentTypePaymentOptions?$top=10>
