...
| [<s>IsReleased</s>](Finance.Accounting.AccountingVouchers.md#isreleased) | boolean | **OBSOLETE! Do not use!** True if the document is not void and its state is released or greater. Deprecated 
| [IsSingleExecution](Finance.Accounting.AccountingVouchers.md#issingleexecution) | boolean | Specifies whether the document is a single execution of its order document. 
