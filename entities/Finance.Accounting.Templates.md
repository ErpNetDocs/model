...
Repository: Finance.Accounting.Templates  
Base Table: Acc_Templates  
...
Finance_Accounting_Template

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Accounting_Templates?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Accounting_Templates?$top=10>
