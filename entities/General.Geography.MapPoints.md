...
Repository: General.Geography.MapPoints  
Base Table: Geo_Map_Points  
...
| [Latitude](General.Geography.MapPoints.md#latitude) | decimal (10, 7) | Latitude is the vertical angle from equator to the pole of the point. Positive values denote points north of the equator. The value is in the range [-90, 90].[-90, 90]. [Required] [Default(0)] 
| [Longitude](General.Geography.MapPoints.md#longitude) | decimal (10, 7) | Longitude is angle from the prime meridian (in England) in east-west direction. Positive values denote east and negative - west. The value is in the range [-180, 180].[-180, 180]. [Required] [Default(0)] 
...
Latitude is the vertical angle from equator to the pole of the point. Positive values denote points north of the equator. The value is in the range [-90, 90].[-90, 90]. [Required] [Default(0)]
...
Longitude is angle from the prime meridian (in England) in east-west direction. Positive values denote east and negative - west. The value is in the range [-180, 180].[-180, 180]. [Required] [Default(0)]
...
General_Geography_MapPoints

Domain API Entity Type: 
General_Geography_MapPoint

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/General_Geography_MapPoints?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#General_Geography_MapPoints?$top=10>
