...
Repository: Production.Resources.OperationInstructions  
Base Table: Prd_Operation_Instructions  
API access:  ReadWrite  

## Visualization
Display Format: {Id}: {Instructions}  
Search Members:   
...
| [ExternalId](Production.Resources.OperationInstructions.md#externalid) | string | The id of the object, when it is imported/synchronized with external system. Used by sync apps to identify the object in external systems. [Filter(multi eq)] [ORD] [Introduced in version 24.1.0.89] |
| [ExternalSystem](Production.Resources.OperationInstructions.md#externalsystem) | string | The name of the external system from which the object is imported/synchronized. [Filter(multi eq)] [Introduced in version 24.1.0.89] |
| [AggregateLastUpdateTimeUtc](Production.Resources.OperationInstructions.md#aggregatelastupdatetimeutc) | datetime | The exact server time (in UTC) of the last modification of the object represented by this system object. null means that it is unknown. [Filter(ge;le)] [ORD] [Introduced in version 19.1] |
| [AdditionalDataJson](Production.Resources.OperationInstructions.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
...
Production_Resources_OperationInstructions

Domain API Entity Type: 
Production_Resources_OperationInstruction

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Production_Resources_OperationInstructions?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Production_Resources_OperationInstructions?$top=10>
