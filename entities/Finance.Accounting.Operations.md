...
| [<s>IsReleased</s>](Finance.Accounting.Operations.md#isreleased) | boolean | **OBSOLETE! Do not use!** True if the document is not void and its state is released or greater. Deprecated 
| [IsSingleExecution](Finance.Accounting.Operations.md#issingleexecution) | boolean | Specifies whether the document is a single execution of its order document. 
