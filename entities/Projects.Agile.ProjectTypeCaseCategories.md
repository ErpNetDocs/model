...
Indicates for each case category which project types it is allowed to be used in.

## General
Namespace: [Projects.Agile](Projects.Agile.md)  
Repository: Projects.Agile.ProjectTypeCaseCategories  
Base Table: Apm_Project_Type_Case_Categories  
Introduced In Version: 25.1.1.51  
API access:  ReadWrite  

## Visualization
Display Format: {CaseCategory.Name:T}  
Search Members: CaseCategory.Name  
Name Member: CaseCategory.Name  
...
Projects_Agile_ProjectTypeCaseCategories

Domain API Entity Type: 
Projects_Agile_ProjectTypeCaseCategory

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Projects_Agile_ProjectTypeCaseCategories?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Projects_Agile_ProjectTypeCaseCategories?$top=10>
