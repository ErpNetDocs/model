...
---
# Communities.Social.Follows


Denotes a user following an object in the system. The user will be notified for events about the object.

## General
Namespace: [Communities.Social](Communities.Social.md)  
Repository: Communities.Social.Follows  
Base Table: Cmm_Social_Follows  
...
| [AdditionalDataJson](Communities.Social.Follows.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
