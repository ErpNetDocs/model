...
Represents a party associated to a document.

## General
Namespace: [General.Documents](General.Documents.md)  
Repository: General.Documents.DocumentParties  
Base Table: Gen_Document_Parties  
Introduced In Version: 22.1.4.46  
...
Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/General_Documents_DocumentParties?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#General_Documents_DocumentParties?$top=10>
