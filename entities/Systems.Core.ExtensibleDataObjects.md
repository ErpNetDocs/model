...
| ---- | ---- | --- |
| [AdditionalDataJson](Systems.Core.ExtensibleDataObjects.md#additionaldatajson) | string (max) __nullable__ | Extensible JSON object for storing this entity's custom or optional attributes.`Introduced in version 26.3.100.4` |
