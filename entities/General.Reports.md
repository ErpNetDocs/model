...
Repository: General.Reports  
Base Table: Gen_Reports  
...
| [AdditionalDataJson](General.Reports.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
