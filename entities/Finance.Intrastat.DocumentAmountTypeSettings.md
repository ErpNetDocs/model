...
Finance_Intrastat_DocumentAmountTypeSettings

Domain API Entity Type: 
Finance_Intrastat_DocumentAmountTypeSetting

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Intrastat_DocumentAmountTypeSettings?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Intrastat_DocumentAmountTypeSettings?$top=10>
