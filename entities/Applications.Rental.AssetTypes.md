...
Repository: Applications.Rental.AssetTypes  
Base Table: Rent_Asset_Types  
API access:  ReadWrite  

## Visualization
Display Format: {RentalAssetTypeName}  
Search Members: RentalAssetTypeName  
Name Member: RentalAssetTypeName  
Category:  Settings  
...
| [AggregateLastUpdateTimeUtc](Applications.Rental.AssetTypes.md#aggregatelastupdatetimeutc) | datetime | The exact server time (in UTC) of the last modification of the object represented by this system object. null means that it is unknown. [Filter(ge;le)] [ORD] [Introduced in version 19.1] |
| [AdditionalDataJson](Applications.Rental.AssetTypes.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
