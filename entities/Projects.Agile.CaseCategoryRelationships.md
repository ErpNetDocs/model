...
---
# Projects.Agile.CaseCategoryRelationships


Defines the parent/child relationship between the case categories.

## General
Namespace: [Projects.Agile](Projects.Agile.md)  
Repository: Projects.Agile.CaseCategoryRelationships  
Base Table: Apm_Case_Category_Relationships  
Introduced In Version: 25.1.2.35  
API access:  ReadWrite  

## Visualization
Display Format: {ChildCaseCategory.Name:T}  
Search Members: ChildCaseCategory.Name  
Name Member: ChildCaseCategory.Name  
...
Projects_Agile_CaseCategoryRelationships

Domain API Entity Type: 
Projects_Agile_CaseCategoryRelationship

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Projects_Agile_CaseCategoryRelationships?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Projects_Agile_CaseCategoryRelationships?$top=10>
