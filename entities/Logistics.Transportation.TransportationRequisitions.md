...
Repository: Logistics.Transportation.TransportationRequisitions  
Inherited From: [General.Documents.Documents](General.Documents.Documents.md)  
Base Table: Log_Transportation_Requisitions  
...
| [FullState](Logistics.Transportation.TransportationRequisitions.md#fullstate) | string | Full state of the document based on its system and user state. [ReadOnly] |
...
| [ExternalId](Logistics.Transportation.TransportationRequisitions.md#externalid) | string | The id of the object, when it is imported/synchronized with external system. Used by sync apps to identify the object in external systems. [Filter(multi eq)] [ORD] [Introduced in version 24.1.0.89] |
| [ExternalSystem](Logistics.Transportation.TransportationRequisitions.md#externalsystem) | string | The name of the external system from which the object is imported/synchronized. [Filter(multi eq)] [Introduced in version 24.1.0.89] |
| [AggregateLastUpdateTimeUtc](Logistics.Transportation.TransportationRequisitions.md#aggregatelastupdatetimeutc) | datetime | The exact server time (in UTC) of the last modification of the object represented by this system object. null means that it is unknown. [Filter(ge;le)] [ORD] [Introduced in version 19.1] |
| [AdditionalDataJson](Logistics.Transportation.TransportationRequisitions.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
...
Type: **[ParentDocument<br />RelationshipType](Logistics.Transportation.TransportationRequisitions.md#parentdocumentrelationshiptype) __nullable__**  
Category: **System**  
...
Type: **[DocumentState](Logistics.Transportation.TransportationRequisitions.md#state)**  
Category: **System**  
...
Logistics_Transportation_TransportationRequisitions

Domain API Entity Type: 
Logistics_Transportation_TransportationRequisition

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Logistics_Transportation_TransportationRequisitions?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Logistics_Transportation_TransportationRequisitions?$top=10>
