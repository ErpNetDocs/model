---
uid: Projects.Classic.Resources
---
# Projects.Classic.Resources
...
Repository: Projects.Classic.Resources  
Base Table: Prj_Resources  
...
[!list limit=1000 erp.entity=Projects.Classic.Resources erp.type=business-rule default-text="None"]

## Front-End Business Rules

[!list limit=1000 erp.entity=Projects.Classic.Resources erp.type=front-end-business-rule default-text="None"]

## API

Domain API Entity Set: 
Projects_Classic_Resources

Domain API Entity Type: 
Projects_Classic_Resource

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Projects_Classic_Resources?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Projects_Classic_Resources?$top=10>
