...
Repository: General.Resources.WorkScheduleWorkingTime  
Base Table: Gen_Work_Schedule_Working_Time  
API access:  ReadWrite  

## Visualization
Display Format: {WorkSchedule.Name}  
Search Members: WorkSchedule.Name  
Name Member: WorkSchedule.Name  
...
General_Resources_WorkScheduleWorkingTime

Domain API Entity Type: 
General_Resources_WorkScheduleWorkingTime

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/General_Resources_WorkScheduleWorkingTime?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#General_Resources_WorkScheduleWorkingTime?$top=10>
