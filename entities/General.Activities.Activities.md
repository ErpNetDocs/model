...
Domain API Query:
<https://demodb.my.erp.net/api/domain/odata/General_Activities_Activities?$top=10>

Domain API Query Builder:
<https://demodb.my.erp.net/api/domain/querybuilder#General_Activities_Activities?$top=10>
