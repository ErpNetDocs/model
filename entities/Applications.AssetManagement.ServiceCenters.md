...
Contains data about the service centers, which can maintain the assets.

## General
Namespace: [Applications.AssetManagement](Applications.AssetManagement.md)  
Repository: Applications.AssetManagement.ServiceCenters  
Base Table: Eam_Service_Centers  
...
| [AdditionalDataJson](Applications.AssetManagement.ServiceCenters.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
