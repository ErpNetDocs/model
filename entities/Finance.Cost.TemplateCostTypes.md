...
Repository: Finance.Cost.TemplateCostTypes  
Base Table: Cost_Template_Cost_Types  
API access:  ReadWrite  

## Visualization
Display Format: {CostTemplate.CostTemplateName}  
Search Members: CostTemplate.CostTemplateName  
Name Member: CostTemplate.CostTemplateName  
Category:  Settings  
...
| [ObjectVersion](Finance.Cost.TemplateCostTypes.md#objectversion) | int32 | The latest version of the extensible data object for the aggregate root for the time the object is loaded from the database. Can be used for optimistic locking. 
| [DisplayText](Finance.Cost.TemplateCostTypes.md#displaytext) | string | Uses the repository DisplayTextFormat to build the display text from the attributes and references of current object. 
...
Finance_Cost_TemplateCostTypes

Domain API Entity Type: 
Finance_Cost_TemplateCostType

Domain API Query:
<https://testdb.my.erp.net/api/domain/odata/Finance_Cost_TemplateCostTypes?$top=10>

Domain API Query Builder:
<https://testdb.my.erp.net/api/domain/querybuilder#Finance_Cost_TemplateCostTypes?$top=10>
