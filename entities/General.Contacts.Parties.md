...
| ---- | ---- | --- |
| [GLN](General.Contacts.Parties.md#gln) | string (13) __nullable__ | Global Location Number - provides the global supply chain solution for the identification of physical locations and legal entities. Used by EDI (Electronic Data Interchange) systems.`Filter(multi eq)` `ORD` |
...
| [AdditionalDataJson](General.Contacts.Parties.md#additionaldatajson) | string | Extensible JSON object for storing this entity&apos;s custom or optional attributes. [Introduced in version 26.3.100.4] |
...
Global Location Number - provides the global supply chain solution for the identification of physical locations and legal entities. Used by EDI (Electronic Data Interchange) systems.`Filter(multi eq)` `ORD`
