...
Offer.RequiredDeliveryDate =
                            if(Offer.Customer != null)
                            , then DocumentDate + Customer.DefaultDeliveryTermDays
                            else DocumentDate
Offer.PaymentDueDate =
                            if(Offer.Customer != null)
                            , then DocumentDate + Customer.DefaultPaymentTermDays
                            else DocumentDate
Offer.PriceList =
                           if(Offer.Customer != null)
                            , then Customer.DefaultPriceList
                            else null
Offer.PaymentType =
                            if(Offer.Customer != null)
                            , then Customer.DefaultPaymentType
                            else null
```
