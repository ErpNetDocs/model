# View Inv_Balances_At_Date


## Entity

Entity: [Logistics.Inventory.BalancesAtDate](~/entities/Logistics.Inventory.BalancesAtDate.md)
...
|[Product_Id](#product_id)|`uniqueidentifier` |The product|
...
|[Quantity_Base](#quantity_base)|`decimal(38, 3)` |The quantity of the stock received/issued in base measurement unit|
...
|[Store_Id](#store_id)|`uniqueidentifier` |The store|
