# Table Saft_Profile_Stock_Movement_Types


## Entity

Entity: [Regulatory.Saft.ProfileStockMovementTypes](~/entities/Regulatory.Saft.ProfileStockMovementTypes.md)

A mapping table defining the relationship between a document type and a SAF-T StockMovementType code within a SAFT profile. It stores which document type corresponds to which StockMovementType code for the selected SAFT profile when generating the SAF-T file. Entity: Saft_Profile_Stock_Movement_Types (Introduced in version 27.1.1.46)
...
|[Saft_Profile_Stock_Movement_Type_Id](#saft_profile_stock_movement_type_id)|`uniqueidentifier` `PK`|Auto-generated GUID for this record.|
...
### Saft_Profile_Stock_Movement_Type_Id
...
#### Saft_Profile_Stock_Movement_Type_Id - Supported Filters
