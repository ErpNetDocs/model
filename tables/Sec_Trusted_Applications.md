...
|[Client_Type](#client_type)|`char(1)` Allowed: `C`, `P`, `N`|Specifies the client type, according to RFC 6749, e.g. the confidentiality of the client app. P=Public (e.g. browser or native app); C=Confidential (e.g. web server app).|
