# Table Saft_Declaration_Export_Purchase_Invoices


## Entity

Entity: [Regulatory.Saft.DeclarationExportPurchaseInvoices](~/entities/Regulatory.Saft.DeclarationExportPurchaseInvoices.md)

Contains Purchase Invoices for SAF-T export section `PurchaseInvoices`. Entity: Saft_Declaration_Export_Purchase_Invoices (Introduced in version 27.1.0.86)
...
|[Declaration_Export_Purchase_Invoice_Id](#declaration_export_purchase_invoice_id)|`uniqueidentifier` `PK`||
...
|[Supplier_City](#supplier_city)|`nvarchar(35)` |Supplier City|
|[Supplier_Country](#supplier_country)|`nvarchar(2)` |Supplier Country|
|[Supplier_Id](#supplier_id)|`nvarchar(35)` |Supplier Id|
|[Supplier_Name](#supplier_name)|`nvarchar(70)` |Supplier Name|
...
### Declaration_Export_Purchase_Invoice_Id
...
#### Declaration_Export_Purchase_Invoice_Id - Supported Filters
