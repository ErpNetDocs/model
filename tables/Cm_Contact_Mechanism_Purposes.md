...
|[Contact_Mechanism_Type](#contact_mechanism_type)|`char(1)` Allowed: `A`, `E`, `F`, `M`, `O`, `T`, `W`, `P`, `X`|When specified, allows the purpose to be specified only for contact mechanisms of the specified type.|
