# Table Crm_Customer_Client_Center_Permissions


## Entity

Entity: [Crm.Sales.CustomerClientCenterPermissions](~/entities/Crm.Sales.CustomerClientCenterPermissions.md)
...
| - | - | --- |
|[Customer_Client_Center_Permissions_Id](#customer_client_center_permissions_id)|`uniqueidentifier` `PK`||
...
|[Notes](#notes)|`nvarchar(max)` |Notes for this Permission.|
|[Role](#role)|`char(3)` Allowed: `L10`, `L20`, `L30`, `L80`, `L90`|The role defines the granted permissions.|
|[Row_Version](#row_version)|`timestamp` ||
|[Ship_To_Customer_Id](#ship_to_customer_id)|`uniqueidentifier` |The customers location, whose data is being accessed.|
|[User_Id](#user_id)|`uniqueidentifier` |The user for whom the access is granted.|

## Columns

### Customer_Client_Center_Permissions_Id
...
#### Customer_Client_Center_Permissions_Id - Supported Filters
...
The role defines the granted permissions.
...
The user for whom the access is granted.
