...
|[Excise_Product_Id](#excise_product_id)|`uniqueidentifier` |The excise product for which the rate is applied.|
...
#### Excise_Duty_Rate - Supported Filters
...
#### Excise_Measurement_Unit_Id - Supported Filters
