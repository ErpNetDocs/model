# Table Saft_Declaration_Export_Suppliers


## Entity

Entity: [Regulatory.Saft.DeclarationExportSuppliers](~/entities/Regulatory.Saft.DeclarationExportSuppliers.md)

Contains Suppliers in SAF-T export section `Suppliers`. Entity: Saft_Declaration_Export_Suppliers (Introduced in version 27.1.0.86)
...
|[Name_Latin](#name_latin)|`nvarchar(70)` |Name Latin|
...
|[Registration_Number](#registration_number)|`nvarchar(35)` |Identification number|
...
City or other place of supplier address
...
### Declaration_Export_Supplier_Id
...
#### Declaration_Export_Supplier_Id - Supported Filters
