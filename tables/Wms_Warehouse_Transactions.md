...
Entity: [Logistics.Wms.WarehouseTransactions](~/entities/Logistics.Wms.WarehouseTransactions.md)
...
|[Task_Type](#task_type)|`char(3)` Allowed: `REC`, `DIS`, `MOV`, `LBL`, `INS`, `PCK`, `UPK`, `KIT`, `DKT`, `CNT`, `TSK`, `CDP`, `CRC`, `ASM`, `DSM`, `RCN`, `PIK`|The type of the task (operation), which was transacted.|
...
#### Catch_Quantity - Supported Filters
...
| Property | Value |
| - | - |
|Allowed Values|`REC`, `DIS`, `MOV`, `LBL`, `INS`, `PCK`, `UPK`, `KIT`, `DKT`, `CNT`, `TSK`, `CDP`, `CRC`, `ASM`, `DSM`, `RCN`, `PIK`|
|Auto Complete|no|
|Data Filter|no|
|Default Value|None|
|Enter Stop|yes|
