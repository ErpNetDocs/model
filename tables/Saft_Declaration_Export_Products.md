# Table Saft_Declaration_Export_Products


## Entity

Entity: [Regulatory.Saft.DeclarationExportProducts](~/entities/Regulatory.Saft.DeclarationExportProducts.md)

Contains Products included in SAF-T export. Entity: Saft_Declaration_Export_Products (Introduced in version 27.1.0.86)
...
#### Declaration_Export_Product_Id - Supported Filters
...
### UOM_To_UOM_Base_Conversion_Factor


UOM To UOM Base Conversion Factor
