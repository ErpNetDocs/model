...
|[Production_Mode](#production_mode)|`char(1)` Allowed: `P`, `D`, `S`|Specifies whether the document is for Production or Decomposition purposes.|
...
#### Production_Mode - Supported Filters
