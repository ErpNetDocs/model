...
Entity: [Projects.AI.ModelQAs](~/entities/Projects.AI.ModelQAs.md)
...
| - | - | --- |
|[Added_By_User_Id](#added_by_user_id)|`uniqueidentifier` Readonly|The user which added the QA.|
|[Answer](#answer)|`nvarchar(max)` |Desired answer.|
|[Creation_Time_Utc](#creation_time_utc)|`datetime` Readonly|The time when the QA was created.|
|[Deactivaton_Time_Utc](#deactivaton_time_utc)|`datetime` Readonly|The time when the QA was deactivated.|
|[Is_Active](#is_active)|`bit` |Indicates whether to include this QA in future builds.|
...
|[QA_Type](#qa_type)|`char(1)` Allowed: `T`, `V`|Specifies whether the QA is training or validation. Validation QAs are used to test the correctness of the model and are only reported in the build logs.|
