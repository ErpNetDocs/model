# Table Crm_Company_Size_Classes


## Entity

Entity: [Crm.Marketing.CompanySizeClasses](~/entities/Crm.Marketing.CompanySizeClasses.md)
...
|[To_Employees](#to_employees)|`int` |Maximum number of employees for this size class. NULL if this is not relevant to this size class.|
|[To_Revenue](#to_revenue)|`decimal(15, 0)` |Maximal revenue for this size class. Currency is Revenue Currency. NULL if this is not relevant to this size class.|
...
#### Revenue_Currency_Id - Supported Filters
