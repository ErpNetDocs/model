# Table Saft_Declaration_Export_Payments


## Entity

Entity: [Regulatory.Saft.DeclarationExportPayments](~/entities/Regulatory.Saft.DeclarationExportPayments.md)

Contains Payments for SAF-T export. Entity: Saft_Declaration_Export_Payments (Introduced in version 27.1.0.86)
...
|[Transaction_Date](#transaction_date)|`datetime` |Transaction Date|
|[Transaction_Id](#transaction_id)|`uniqueidentifier` |Transaction identifier|

## Columns

### Declaration_Export_Payment_Id
...
#### Declaration_Export_Payment_Id - Supported Filters
