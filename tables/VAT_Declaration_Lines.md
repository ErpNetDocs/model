...
|[Declaration_Line_Id](#declaration_line_id)|`uniqueidentifier` `PK`||
...
|Primary Key|no|
|Readonly|no|
|Referenced Table|[VAT_Declarations](VAT_Declarations.md)|
|RTF|no|
|Sortable|no|
|Summary Type|None|
|Supports EQUALS_IN|yes|
...
#### Declaration_Line_Id - Supported Filters
