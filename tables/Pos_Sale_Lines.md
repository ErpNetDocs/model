...
|[Execution_Stage](#execution_stage)|`nvarchar(3)` |Execution status of the line. Used only for businesses with real-time execution tracking (restaurants, bars, services, etc.).|
...
|[Pos_Sale_Line](#pos_sale_line)|`uniqueidentifier` `PK`||
...
#### Pos_Sale_Line - Supported Filters
