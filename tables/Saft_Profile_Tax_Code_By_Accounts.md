# Table Saft_Profile_Tax_Code_By_Accounts
...
| - | - | --- |
|[Account_Id](#account_id)|`uniqueidentifier` |The ERP.net general ledger account for which the SAF-T tax code is defined.|
|[Custom_Property_Id](#custom_property_id)|`uniqueidentifier` |The account analytic custom property used to differentiate the applicable SAF-T tax code.|
|[Custom_Property_Value](#custom_property_value)|`nvarchar(254)` |The specific value of the selected analytic custom property for which this mapping applies.|
...
|[Profile_Tax_Code_By_Account_Id](#profile_tax_code_by_account_id)|`uniqueidentifier` `PK`|Unique identifier of the mapping record.|
|[Row_Version](#row_version)|`timestamp` ||
|[Tax_Code_Entry_Id](#tax_code_entry_id)|`uniqueidentifier` |The SAF-T Tax Code to output when the criteria (account + analytic + document type) are met.|
...
#### Custom_Property_Id - Supported Filters
...
#### Custom_Property_Value - Supported Filters
...
### Profile_Tax_Code_By_Account_Id
...
#### Profile_Tax_Code_By_Account_Id - Supported Filters
