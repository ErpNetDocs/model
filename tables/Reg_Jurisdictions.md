# Table Reg_Jurisdictions


## Entity

Entity: [Regulatory.Common.Jurisdictions](~/entities/Regulatory.Common.Jurisdictions.md)
...
| - | - | --- |
|[Code](#code)|`nvarchar(50)` |Short code of the jurisdiction (ISO-style preferrable).|
...
|[Valid_From](#valid_from)|`date` |When not null specifies the first date when the jurisdiction is valid.|
|[Valid_To](#valid_to)|`date` |When not null specifies the last date (inclusive) when the jurisdiction is valid.|
...
#### Country_Code - Supported Filters
...
#### Currency_Sign - Supported Filters
