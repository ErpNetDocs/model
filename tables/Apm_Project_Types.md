# Table Apm_Project_Types


## Entity

Entity: [Projects.Agile.ProjectTypes](~/entities/Projects.Agile.ProjectTypes.md)
...
|[Project_Type_Name](#project_type_name)|`nvarchar(254)` `ML`|Multi-language name of the project type.|
