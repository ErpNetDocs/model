# View Acc_Account_Statement


## Entity

Entity: [Finance.Accounting.AccountStatement](~/entities/Finance.Accounting.AccountStatement.md)
...
|[Balance](#balance)|`decimal(38, 2)` |Balance is running sum of (Opening + Debit - Credit) calculated for each row of group.|
|[Balance_Base](#balance_base)|`decimal(38, 2)` |Calculated as Balance over Base currency.|
|[Balance_Reporting](#balance_reporting)|`decimal(38, 2)` |Calculated as Balance over Reporting currency.|
|[Closing](#closing)|`decimal(38, 2)` |Closing Balance(at the end of reporting period)|
|[Closing_Base](#closing_base)|`decimal(38, 2)` |Closing Balance(in Base currency)|
...
|[Release_Time](#release_time)|`datetime` |Document Release Time|
|[To_Date](#to_date)|`date` |Period End Date - Should be filtered with exact date|
|[Voucher_Line_Id](#voucher_line_id)|`uniqueidentifier` |Voucher Line reference|
