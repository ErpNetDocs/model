# Table Saft_Profile_Payment_Types
...
|[Payment_Mechanism_Code_Entry_Id](#payment_mechanism_code_entry_id)|`uniqueidentifier` |Payment Mechanism used when generating the SAFT file.|
|[Payment_Type_Id](#payment_type_id)|`uniqueidentifier` |PaymentType used for this SAFT profile|
|[Profile_Id](#profile_id)|`uniqueidentifier` |Identifier of the SAFT profile associated with this payment type.|
|[Row_Version](#row_version)|`timestamp` ||
|[Saft_Profile_Payment_Type_Id](#saft_profile_payment_type_id)|`uniqueidentifier` `PK`|Auto-generated GUID for this record.|
...
### Payment_Mechanism_Code_Entry_Id
...
#### Payment_Mechanism_Code_Entry_Id - Supported Filters
...
#### Saft_Profile_Payment_Type_Id - Supported Filters
