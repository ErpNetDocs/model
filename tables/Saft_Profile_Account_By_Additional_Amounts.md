# Table Saft_Profile_Account_By_Additional_Amounts


## Entity

Entity: [Regulatory.Saft.ProfileAccountByAdditionalAmounts](~/entities/Regulatory.Saft.ProfileAccountByAdditionalAmounts.md)
...
|[Amount_Type_Id](#amount_type_id)|`uniqueidentifier` |The ERP.net Amount type for which the SAF-T account is defined.|
...
|[Profile_Account_By_Additional_Amount_Id](#profile_account_by_additional_amount_id)|`uniqueidentifier` `PK`|Unique identifier of the record (GUID).|
...
#### Amount_Type_Id - Supported Filters
...
### Profile_Account_By_Additional_Amount_Id
...
#### Profile_Account_By_Additional_Amount_Id - Supported Filters
