...
|[Job_Type](#job_type)|`char(3)` Allowed: `DOC`, `POS`, `DNT`, `DPI`, `DDV`, `DIM`, `DAC`, `DAL`, `CTE`, `CRC`, `ICP`, `DRT`, `CEO`|The system type of the job. DOC=Document Change State, POS=Run Postponed Events, DNT=Delete Old Notifications, DPI=Delete Old Print Images, DDV=Delete Old Document Versions, DIM=Delete Old Information Messages.|
...
| Property | Value |
| - | - |
|Allowed Values|`DOC`, `POS`, `DNT`, `DPI`, `DDV`, `DIM`, `DAC`, `DAL`, `CTE`, `CRC`, `ICP`, `DRT`, `CEO`|
|Auto Complete|no|
|Data Filter|no|
|Default Value|None|
|Enter Stop|yes|
