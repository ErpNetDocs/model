# Table Wms_Warehouse_Counts


## Entity

Entity: [Logistics.Wms.WarehouseCounts](~/entities/Logistics.Wms.WarehouseCounts.md)
...
|[Quantity](#quantity)|`decimal(12, 3)` Readonly|The quantity entered during the counting process, in the entered measurement unit.|
|[Quantity_Base](#quantity_base)|`decimal(12, 3)` Readonly|The converted quantity in the product’s base measurement unit.|
|[Quantity_Unit_Id](#quantity_unit_id)|`uniqueidentifier` Readonly|The measurement unit used when entering the quantity.|
|[Row_Version](#row_version)|`timestamp` ||
|[Serial_Number_Id](#serial_number_id)|`uniqueidentifier` Readonly|Serial number, when serialized tracking is enabled.|
|[Session](#session)|`int` Readonly|The counting session number to which this entry belongs.|
...
#### Standard_Quantity_Base - Supported Filters
...
#### Warehouse_Count_Id - Supported Filters
