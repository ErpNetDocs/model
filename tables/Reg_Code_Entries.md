# Table Reg_Code_Entries


## Entity

Entity: [Regulatory.Common.CodeEntries](~/entities/Regulatory.Common.CodeEntries.md)
...
#### Additional_Data_Json - Supported Filters
...
#### Code_Entry_Id - Supported Filters
...
|Primary Key|no|
|Readonly|no|
|Referenced Table|[Reg_Code_Lists](Reg_Code_Lists.md)|
|RTF|no|
|Sortable|no|
|Summary Type|None|
|Supports EQUALS_IN|yes|
...
#### Parent_Entry_Id - Supported Filters
